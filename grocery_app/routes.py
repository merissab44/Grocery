...
def new_store():
    ...
    if form.validate_on_submit():
        ...
        flash('New grocery store has been added.')
...
def store_detail(store_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.add(new_store)
        db.session.commit()
        flash('Store has been updated!')
        return redirect(url_for('main.store_detail', store_id=store.id, store=new_store))
...
def item_detail(item_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.add(new_item)
        db.session.commit()
        flash('You\'ve updated your item successfully!')
